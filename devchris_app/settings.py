"""
Django settings for devchris project.
...
ROOT_URLCONF = 'devchris_app.urls'
...
WSGI_APPLICATION = 'devchris_app.wsgi.application'
...
'extends': {
    'blockToolbar': [
        'p', 'heading1', 'heading2', 'heading3',
        '|',
        'bulletedList', 'numberedList',
        '|',
        'blockQuote',
    ],
    'toolbar': ['heading', '|', 'fontSize', 'fontFamily', 'fontColor', '|', 'bold', 'italic', 'link', 'underline',
